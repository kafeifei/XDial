...
extension Profile {
    ...
    static func templateDomestic(ruleSetIDs: [String], remoteRuleSetID: String, vpnLineID: String, directLineID: String) -> Mode {
    ...
    static func templateDomesticSS(ruleSetIDs: [String], remoteRuleSetID: String, vpnLineID: String, ssLineID: String, directLineID: String) -> Mode {
