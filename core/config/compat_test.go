...
const newFormatProfileJSON = `{
  ...
  "rule_sets": [
    ...
    {"id": "remote", "name": "REMOTE", "type": "url", "enabled": true,
     "url": "https://example.com/remote.srs", "format": "srs"}
  ],
  "modes": [
    {"id": "m1", "name": "默认",
     "bindings": [
       {"rule_set_id": "corp", "line_id": "vpn"},
       {"rule_set_id": "remote", "subscription_id": "sub1"}
     ],
  ...
  "cruises": [
    {"id": "m1", "name": "默认",
     "bindings": [
       ...
       {"cargo_id": "remote", "subscription_id": "sub1"}
     ],
