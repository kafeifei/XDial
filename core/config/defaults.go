	...
	return []Preset{
		{
			...
			Bindings: []Binding{
				...
				{DiverterID: DiverterIDREMOTE, LineID: LineIDDirect},
			},
		},
		{
			ID:   PresetIDDomestic,
			...
			Bindings: []Binding{
				{DiverterID: DiverterIDCompany, LineID: LineIDCompanyVPN},
				{DiverterID: DiverterIDREMOTE, LineID: LineIDCompanyVPN},
			},
		},
		{
			...
			Bindings: []Binding{
				{DiverterID: DiverterIDCompany, LineID: LineIDCompanyVPN},
				{DiverterID: DiverterIDREMOTE, LineID: LineIDAirport},
			},
		},
	}
}
